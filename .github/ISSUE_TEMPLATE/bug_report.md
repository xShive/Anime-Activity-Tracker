...
- Is the official Discord Desktop App running and logged in?: [Yes/No]
- Is the background script (```rpc.py```) running?: [Yes/No]
- Which website is this happening on?: [e.g. Crunchyroll, Miruro.tv, All of them]
